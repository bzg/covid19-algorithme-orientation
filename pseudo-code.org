...
:  5  SI fièvre
:  6     SI toux
:  7        SI >=1 facteur pronostique ET >=2 facteurs de gravité mineurs => FIN4
:  8        SINON => FIN6
:  9     SI diarrhée OU douleurs OU anosmie
: 10        SI >=1 facteur pronostique ET >=2 facteurs de gravité mineurs => FIN4
: 11        SI >= 50 ans OU >=1 facteur de gravité mineur => FIN3
: 12        SINON => FIN2
: 13
: 14  SI toux OU douleurs OU anosmie
: 15     SI >=1 facteur de gravité mineur OU >=1 facteur pronostique => FIN8
: 16     SINON => FIN7
: 17
: 18  SINON => FIN9
