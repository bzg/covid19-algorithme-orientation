...
:  4:    SI 0 facteur pronostique => FIN6
:  5:    SI >= 1 facteurs pronostiques
:  6:       SI 0 OU 1 facteur de gravité mineur => FIN6
:  7:       SI >= 2 facteurs de gravité mineurs => FIN4
:  8: 
:  9: SI fièvre OU (pas de fièvre et (diarrhée OU (toux ET douleurs) OU (toux ET anosmie))
: 10:    SI >= 1 facteurs de gravité majeurs => FIN5
