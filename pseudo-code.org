...
:     SI <15 ans => FIN1
:
:     SI 1 OU plus facteur(s) de gravité majeur => FIN5
:
:     SI fièvre ET toux
:        SI au moins 1 facteur pronostique
...
:           SI >= 50 ans ou au moins 1 facteur de gravité mineur => FIN3
:           SINON => FIN2
:
:     SI pas de fièvre ET (toux OU douleurs OU anosmie)
:        SI au moins 1 facteur de gravité mineur OU 1 facteur pronostique => FIN8
:        SINON => FIN7
:
:     SI NI toux NI douleurs NI anosmie NI fièvre => FIN9
