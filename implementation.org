...
| =date=                           | Date de saisie par le répondant        | date ISO 8601      | Ex. 2020-04-02T05:24:57.711-00:00                    |
...
|--------------------------------+----------------------------------------+--------------------+------------------------------------------------------|
| =sore_throat_aches=              | Mal de gorge ou douleurs musculaires?  | boolean            | =true= ou =false=                                        |
...
| =cancer=                         | Cancer actuel ou il y a moins de 3 ans | boolean            | =true= ou =false=                                        |
| =diabetes=                       | Diabète                                | boolean            | =true= ou =false=                                        |
| =feeding_day=                    | Difficulté pour manger/boire           | boolean            | =true= ou =false=                                        |
| =kidney_disease=                 | Insuffisance rénale chronique dialysée | boolean            | =true= ou =false=                                        |
...
| =immunosuppressant_disease=      | Maladie défenses immunitaires          | integer            | 0 ou 1 ou 999                                        |
