...
(defn head [meta]
  [:head
   ...
   [:meta {:name "twitter:title", :content (:index-title meta)}]
...
(defn generate-web-index []
  (spit "docs/index.html" (default index-fr-meta index-fr-contents))
