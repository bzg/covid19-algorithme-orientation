...
(def website (inline-yaml-resource "website.yml"))
...
(defn head []
  [:head
   ...
   [:link {:rel "canonical" :href (:url website)}]
   [:meta {:property "og:locale", :content "fr_FR"}]
   [:meta {:property "og:type", :content "website"}]
   [:meta {:property "og:title", :content (:index-title website)}]
   [:meta {:property "og:url", :content (:url website)}]
   [:meta {:property "og:site_name", :content (:index-title website)}]
...
(defn default []
  (let [title    (:index-title website)
        subtitle (:index-subtitle website)]
    (h/html5
     {:lang "fr"}
     (head)
     [:body
